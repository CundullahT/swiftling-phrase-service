...
public class PhraseServiceApplication {
    ...
    public static void main(String[] args) {
        ...
        SpringApplication app = new SpringApplication(PhraseServiceApplication.class);
        ...
        defaultProperties.put("info.application.name", "swiftling-phrase-service");
        defaultProperties.put("info.application.description", "Swiftling App's Phrase Service");
